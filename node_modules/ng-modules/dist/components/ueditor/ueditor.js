...
var UEditorComponent = (function () {
    ...
    UEditorComponent.prototype.ngOnInit = function () {
        ...
        this.ue = window.UE.getEditor(this.editor.nativeElement, Object.assign({
    ...
    ], UEditorComponent.prototype, "editor", void 0);
    __decorate([
        Input("config"),
            ...
            providers: [
                {
                    ...
                    useExisting: forwardRef(function () { return UEditorComponent_1; }),
                    multi: true
                }
            ]
        }),
